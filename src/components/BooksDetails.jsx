  ...
  return (
    <div className="px-6 py-10 mt-10 flex flex-col md:flex-row items-center md:items-start gap-10">
      ...
      <div className="max-w-xl text-left">
        <h1 className="text-3xl font-bold text-blue-700 mb-3">{book.title}</h1>
        ...
        <p className="text-yellow-600 font-medium mb-4">⭐ {book.rating} / 5</p>
        ...
        <p className="text-gray-800 font-semibold">
          Copies Sold: <span className="text-blue-600">{book.copies_sold}</span>
        </p>
      </div>
    </div>
  );
